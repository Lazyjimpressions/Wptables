...
$cfg['blowfish_secret']					= 'bHxQ%a&sULk=sk]O#ovP(N7`bwf!AYIC' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_bQu61BgTzGAqlDWmPFh3kf4/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://wp-tables.com/wp-admin/?rand=47455765&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://wp-tables.com/wp-admin/?rand=83577586&pma_logout=1';
